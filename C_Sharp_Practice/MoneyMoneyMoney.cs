 ...
 * is paid yearly, and the new sum is re-invested yearly after 
 * paying tax 'T' 
 ...
 * to ammount to the desired sum. Your task is to complete the method 
 * provided and return the number of years 'Y' as a whole in order
 * for Mr. Scrooge to get the desired sum. Assumptions : Assume that 
 * Desired Principal 'D' is always greater than the initial principal, 
 * however it is best to take into consideration that if the Desired
